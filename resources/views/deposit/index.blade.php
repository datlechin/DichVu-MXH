                            ...
                            <div class="card-body">
                                <form action="{{ route('deposit') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" data-choices data-choices-search-false name="telco"
                                                id="telco">
                                            <option value="">Chọn loại thẻ</option>
                                            <option value="VIETTEL" @selected(old('telco') === 'VIETTEL')>Thẻ Viettel
                                            </option>
                                            <option value="MOBIFONE" @selected(old('telco') === 'MOBIFONE')>Thẻ
                                                Mobiphone
                                            </option>
                                            <option value="VINAPHONE" @selected(old('telco') === 'VINAPHONE')>Thẻ
                                                Vinaphone
                                            </option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" data-choices data-choices-search-false
                                            ...
                                            <option value="100000" @selected(old('amount') === '100000')>100,000đ
                                            </option>
                                            <option value="200000" @selected(old('amount') === '200000')>200,000đ
                                            </option>
                                            <option value="500000" @selected(old('amount') === '500000')>500,000đ
                                            </option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="serial" name="serial"
                                               placeholder="Nhập số serial thẻ" value="{{ old('serial') }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="pin" class="form-label">Mã thẻ</label>
                                        <input type="text" class="form-control" id="pin" name="pin"
                                               placeholder="Nhập mã thẻ" value="{{ old('pin') }}">
                                    </div>
                                    <div class="text-end">
